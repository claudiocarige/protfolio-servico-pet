...
public class DBService {
	...
	public void startDB() {
		...
		Employee employee2 = new Employee(null,"Fulano de tal 01", "41024767760", "fulano02@mail.com", encoder.encode("123456"));
		Employee employee3 = new Employee(null,"Fulano de tal 02", "76778547880", "fulano03@mail.com", encoder.encode("123456"));
		Employee employee4 = new Employee(null,"Fulano de tal 03", "66721243490", "fulano04@mail.com", encoder.encode("123456"));
		Employee employee5 = new Employee(null,"Fulano de tal 04", "30453251900", "fulano05@mail.com", encoder.encode("123456"));
